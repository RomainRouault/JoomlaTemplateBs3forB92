...
<!-- Override : Si pas d image d intro définie, alors une image par défaut -->
<?php if (empty($images->image_intro)) : ?>
	<?php if ($pageclass == ' commission') : ?>
	...
	<?php elseif ($pageclass == ' brochures') : ?>
	<a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($displayData->slug, $displayData->catid, $displayData->language)); ?>">
		<div class="users">
			<i class="fa fa-book fa-5x"  aria-hidden="true"></i>
		</div>
	</a>
	<?php elseif ($pageclass == ' fichiers') : ?>
	<a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($displayData->slug, $displayData->catid, $displayData->language)); ?>">
		<div class="users">
	...
	<?php else : ?>
	<div class="item-image intro-image default-image">
		<a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($displayData->slug, $displayData->catid, $displayData->language)); ?>"><img src="/templates\bib92\images\logo-bib92-fond2.png"></a>
	</div>
	<?php endif; ?>
<?php endif; ?>
...
<!-- Override : pas de - pull ?php echo htmlspecialchars($imgfloat, ENT_COMPAT, 'UTF-8'); - Pas de float -->
